...
export class SalesProdService {
  constructor() {
    ...
    this.salesPageContainer = document.getElementById("sales-page-container");
  ...
  async createFirstCategoryPage() {
    ...
    this.salesPage.classList.remove("d-none");
  ...
  createAnyCategoryPage() {
    ...
    CategoryCards.createCards(this.currentProducts, this.salesPageContainer);
